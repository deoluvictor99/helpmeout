...
const Footer = () => {
    return (
        <>
            <footer className='bg-[#120B48] px-[8rem] py-[6rem] flex justify-between  gap-x-[6rem]'>
                <div className='flex  items-start'>
                    <div className='flex items-center gap-x-[0.5rem]'>
                        ...
                        <Link href={'/'} className='font-Inter font-bold text-white'>HelpMeOut</Link>
                    </div>
                </div>
                <div>
                    <div className='flex justify-between gap-x-[12rem] '>
                        <ul className='font-Worksans text-white space-y-4 '>
                            <li className='font-Sora font-bold '><Link href={"/"}>Menu</Link></li>
                            <li ><Link href={"/"}>Home</Link></li>
                            <li ><Link href={"/"}>Converter</Link></li>
                            <li ><Link href={"/"}>How it Works</Link></li>
                        </ul>
                        <ul className='font-Worksans text-white space-y-4 '>
                            <li className='font-Sora font-bold '><Link href={"/"}>About us</Link></li>
                            <li ><Link href={"/"}>About</Link></li>
                            <li ><Link href={"/"}>Contact Us</Link></li>
                            <li ><Link href={"/"}>Privacy Policy</Link></li>
                        </ul>
                        <ul className='font-Worksans text-white space-y-4 '>
                            <li className='font-Sora font-bold '><Link href={"/"}>Screen Record</Link></li>
                            <li className='' ><Link href={"/"}>Browser Window</Link></li>
